...
/*            $Id: TPM_Types.h 369 2015-08-04 18:48:58Z kgoldman $		*/
/*										*/
...
#endif
#ifdef TPM_ALG_XOR
    TPMI_ALG_HASH		xor;	/* TPM_ALG_XOR	overload for using xor */
#endif
...
#endif
#ifdef TPM_ALG_XOR
    TPMS_SCHEME_XOR	xor;	/* TPM_ALG_XOR 	the "obfuscation" scheme */
#endif
